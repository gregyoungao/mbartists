...
//   - Hero: artist image only, no fade overlay, "All Artists" back link
//   - Intro: name + genres + socials (full width left)
//   - Bio + Agent grid:
//       Left col: Biography
//       Right col: small bio ABOVE the agent box, then Agent + Make Enquiry
//   - Spotlight tracks
// =========================================================
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <main className="relative z-20">
        {/* Hero — artist image, no fade overlay */}
        <section className="relative h-[60vh] min-h-[450px] overflow-hidden">
          ...
          <div className="absolute bottom-8 left-8 md:bottom-12 md:left-16">
            <Link
              href="/artists"
              className="inline-flex items-center gap-2 font-mono text-[10px] uppercase tracking-widest px-4 py-2 border transition-all duration-200 hover:border-[#4E7DFE] hover:text-[#4E7DFE]"
              style={{
        ...
        {/* Intro — name + genres/locations + socials (single column, left-aligned) */}
        <section className="px-8 md:px-16 pt-12 md:pt-16 pb-12">
        ...
        <section className="px-8 md:px-16 pb-16">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-20">
              ...
              {/* Right col — small bio ABOVE agent box */}
              <div>
                {/* Small bio — smaller text, sits above the agent card */}
                {artist.small_bio && (
                  <p
