// =========================================================
// /dashboard
// Placeholder agent dashboard. Real content comes in Step 4.
// =========================================================
      ...
      <section className="pt-32 pb-16 px-6 md:px-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 mb-12">
            <Stat label="Role" value="Agent" />
            <Stat label="Agent Record ID" value={user.agentId || '—'} mono />
          ...
          >
            ...
            <p style={{ color: '#888' }}>
              Your roster, new artist form, and enquiries inbox will appear here in Step 4.
            </p>
          </div>
