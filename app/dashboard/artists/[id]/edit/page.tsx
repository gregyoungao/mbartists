// =========================================================
// /dashboard/artists/[id]/edit — agent edits their artist
// =========================================================
...
export default async function EditArtistByAgentPage({
  params,
}: {
  ...
  // Permission check: must be primary or secondary agent of this artist
  if (
  ...
  const isPrimary = artist.primary_agent_id === user.agentId
  ...
  return (
    <section className="px-6 md:px-12 py-12 pt-20 md:pt-12">
      ...
      <p className="font-mono text-xs mb-12" style={{ color: '#666' }}>
        You are editing this as the {isPrimary ? 'primary' : 'secondary'} agent.
      </p>
      ...
      <ArtistForm
        ...
        genres={genres || []}
        locations={locations || []}
        lockPrimaryAgent={!isPrimary} // secondary agents can't change primary
