...
export default function AgentDetailView({ agent }: { agent: AgentDetail }) {
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(78, 125, 254, 0.12) 0%, transparent 70%)",
            ...
            <div className="flex items-end justify-between mb-8">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {agent.roster.length}{" "}
                  {agent.roster.length === 1 ? "Artist" : "Artists"}
                </p>
              </div>
              <Link
                href="/artists"
                  ...
                  >
                    ...
                    {hoveredIndex === index && (
                      <div
                        ...
                        style={{
                          background:
                            "radial-gradient(circle at 50% 50%, rgba(78, 125, 254, 0.2) 0%, transparent 70%)",
                        }}
                      />
                    )}
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end p-3">
                      <h3
                        ...
                        style={{
                          color: hoveredIndex === index ? "#4E7DFE" : "#fff",
                        }}
                      >
                        {artist.name}
                      </h3>
