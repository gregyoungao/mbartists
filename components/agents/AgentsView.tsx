...
import type { PublicAgent } from "@/app/agents/page"

export default function AgentsView({ agents }: { agents: PublicAgent[] }) {
      ...
      <section className="pt-32 pb-16 px-6 md:px-12 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg max-w-2xl" style={{ color: "#666" }}>
            Meet the dedicated team behind MB Artists, working tirelessly to
            support and elevate our roster.
          </p>
        </div>
      </section>
          ...
          {agents.length === 0 ? (
            <div className="text-center py-24">
              ...
              <p className="font-mono text-sm" style={{ color: "#444" }}>
                Agent profiles will appear here soon.
              </p>
            </div>
          ) : (
              ...
              {agents.map((agent, index) => (
                ...
                >
                  <div
                    ...
                    style={{
                      borderColor:
                        hoveredIndex === index ? "#4E7DFE" : "#1a1a1a",
                      background:
                        hoveredIndex === index ? "#0a0a0a" : "#050505",
                      boxShadow:
                        hoveredIndex === index
                          ? "0 0 40px rgba(78, 125, 254, 0.1)"
                          : "none",
                    }}
                  >
                    {/* Photo and name */}
                    ...
                    >
                      ...
                      >
                        {agent.rosterCount}{" "}
                        {agent.rosterCount === 1 ? "artist" : "artists"}
                      </span>
                      <span
